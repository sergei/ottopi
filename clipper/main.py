...
def main(args):
    ...
    if args.scenario is None:
        ...
        events_json_name, scenario_file = create_events(args, config, movie_name, navigator, start_time_utc,
                                                        finish_time_utc)
        ...
        for movie in scenario['movies']:
            ...
            extra_events = movie['events'] if 'events' in movie else None

            # Make events for this movie
            events_json_name, scenario_file = create_events(args, config, movie_name, navigator, start_time_utc,
                                                            finish_time_utc, extra_events)
...
def create_events(args, config, movie_name, navigator, start_time_utc, finish_time_utc, extra_events=None):
    ...
    return events_json_name, scenario_file
